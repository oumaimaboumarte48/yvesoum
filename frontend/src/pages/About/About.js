    ...
    return (
        ...
        <Helmet>
            ...
            <div className='Content1'>
                ...
                <p>Commodo est cillum laboris proident exercitation veniam excepteur do mollit aliquip irure. Consequat adipisicing commodo anim aliqua labore nisi reprehenderit dolore aliquip in eu est nulla. Ea sint adipisicing elit id ullamco nisi cupidatat nisi labore.
                   ...
                   <div className ='imagecontainer'>
                    ...
                    <Image className='mImage' boxSize = '400px' objectFit="cover" src='https://mfiles.alphacoders.com/610/610179.jpg' alt="Segun Adebayo"/>
                    </div>
                   </div>
            </div>
            <div className ='Content2'>
                   ...
                   <div className ='imagecontainer'>
                    <div className = 'Imageabt'>
                    <Image className='mImage' boxSize = '400px' objectFit="cover" src='https://www.wallpaperuse.com/wallp/40-403998_m.jpg' alt="Segun Adebayo"/>
                    </div>
                   </div>
                   <div className = 'text'>
                    <h1>
